...
class BetEnableView extends GetView<BetEnableController> {
  const BetEnableView({super.key});
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PrimaryAppBar(title: 'Enable Bet'),
      body: Center(
        child: Column(
          children: [
            ProfileCard(),
        ...
        children: [
          if (controller.isLoading.value)
            ...
            NormalButton(
              ...
              onPressed: controller.enableBet,
            ),
