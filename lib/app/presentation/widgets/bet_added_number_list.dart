...
class BetAddedNumberList extends StatelessWidget {
  const BetAddedNumberList({super.key, required this.controller});
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            InkWell(
                              onTap: () {
                                var newAmount = betEntry['amount'] ?? 0;
                                newAmount += 100;
                            ...
                            Expanded(
                              child: TextField(
                                controller: TextEditingController(
                                  text: (betEntry['amount'] as int).toString(),
                                ),
